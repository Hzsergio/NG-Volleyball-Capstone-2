...
class DivisionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Division
        fields = ('name', 'admin', 'publicProfile', 'admin_username', 'status', 'description', 'category', 'defaultLocation', 'tournament_type', 'start_date', 'end_date', 'formatted_start_date', 'formatted_end_date')
